...
<div id="container" class='container-fluid'>
	...
	<div id="container-primary" class='row'>	
		<div id="sidebar" class="col-xl-3 col-lg-3 col-sm-3 col-xs-3">				
				<img id="header-overflow" src="<?php echo get_template_directory_uri()."/images/header-overflow.png";?>" alt="Profile Picture">
		...
		<div id="container-secondary" class="col-xl-9 col-lg-9 col-sm-9 col-xs-9">						
			<div id='header' class="row">
				<!--img id="header-bg" src="<?php echo get_template_directory_uri()."/images/header-background.png";?>" alt="Header-BG"-->
			</div>
